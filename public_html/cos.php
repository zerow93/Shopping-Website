...
<!-- JS ============================================= -->
  ...
  <script src="js/schimbacantitate.js"></script>
  <script src="js/jquery.lightbox-0.5.js"></script>
  <?php if (isset($_SESSION['idprodusecos'])){ foreach ($_SESSION['idprodusecos'] as $idd) { ?>
  <script>
  var idprod = '<?php Print($idd); ?>';
  $(document).on('click', '.plus_produs'+idprod, function(e){
          e.preventDefault();
          fieldName = $(this).data('field-qty');
          var stockvalabil = <?php Print($_SESSION['instock'][$idd]); ?>;
          ...
          $('#quantity_wanted'+idprod).change();
          var currentVal2 = parseInt($('input[name='+fieldName+']').val());

          actualizeaza(fieldName, currentVal2);
  });
  $(document).on('click', '.minus_produs'+idprod, function(e){
          e.preventDefault();
          fieldName = $(this).data('field-qty');
          var currentVal = parseInt($('input[name='+fieldName+']').val());
...
<?php }} ?>
  ...
  <script src="js/adaugacos2.js"></script>
<!-- JS END ============================================= -->
</body>
</html>
